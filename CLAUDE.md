...
│   │   │   └── match-requests/   # 경기 확인 요청 허브 = 미확정 전량의 작업 큐 (내 차례/상대 대기/이의 처리 3탭 상호배타, 0061·0062)
...
/me/match-requests → 경기 확인 요청 허브 (미확정 전량의 작업 큐 — 내 차례 기본 / ?tab=waiting 상대 대기 / ?tab=disputed 이의 처리 — 이의를 거친 협상은 확정까지 여기 머문다. 세 탭은 상호배타)

> **보관본** — 2026-09-08 시점의 `CLAUDE.md` 원본 스냅샷(Week 1~38 서사). 현행 규칙은 루트 `CLAUDE.md`, Week 39~68 서사는 `claude-md-2026-09-16.md`. 읽을 때: 여기 적힌 경로·라벨·IA는 그 시점의 것이라 지금 코드와 다를 수 있다.

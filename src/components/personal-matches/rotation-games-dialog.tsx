 ...
 */
export function RotationGamesDialog({ open, onOpenChange, session, picker, onSubmit, isPending, error }: Props) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
                ...
                <RotationGamesPanel session={session} picker={picker} onSubmit={onSubmit} isPending={isPending} error={error} />
            </DialogContent>
        </Dialog>
    )
}

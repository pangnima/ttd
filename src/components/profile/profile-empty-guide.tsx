    ...
    return (
        <div className="space-y-3">
            <div className="space-y-0.5">
                <p className="text-body font-semibold text-foreground">아직 등록된 경기가 없어요</p>
                <p className="text-body2 text-muted-foreground">첫 경기를 기록하면 승률·전적·NTRP 추이가 자동으로 채워져요.</p>
            </div>

...
type Props = {
    /** 방장이 닫은 방(0083) — 문구가 '종료'에서 '마감'으로, 잠금 사실을 함께 말한다 */
    closed?: boolean
    /** 방장에게만 [다시 열기]가 있다는 것을 말한다 — 참가자는 방장에게 요청해야 한다 */
    isHost?: boolean
}
 ...
 * 마감(0083)은 한 단계 더 — 결과 정정까지 잠겼고, 풀 수 있는 사람은 방장뿐이라는 것을 말한다.
 */
            ...
            <div className={`${CARD_BASE} flex items-start gap-2.5 px-4 py-3 border-border bg-muted/40`}>
                ...
                <p className="text-body2 text-foreground break-keep">
                    ...
                    <span className="text-muted-foreground">
                        ...
                        {isHost ? '고칠 것이 있으면 [다시 열기]로 잠금을 풉니다.' : '고칠 것이 있으면 방장에게 다시 열기를 요청하세요.'}{' '}
                        확정된 전적은{' '}

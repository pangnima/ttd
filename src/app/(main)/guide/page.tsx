...
const SECTIONS: GuideSection[] = [
    ...
    },
    {
        ...
        steps: [
            '「경기 확인 요청」은 «내 차례» · «상대 대기» · «이의 제기» 세 탭입니다. 사이드바 숫자는 «내 차례»와 «이의 제기»에서 내가 다시 입력할 건수를 더한 것이에요.',
            '한 명이 게임 스코어를 제안하면 나머지 회원 참가자가 각자 확인하거나 이의를 제기합니다. 복식은 4명이 모두 확인해야 확정되고, 이의가 나오면 제안자가 «이의 제기» 탭에서 다시 입력합니다. 이의를 낸 사람과 다른 참가자는 그 탭에서 기다려요.',

...
const SECTIONS: GuideSection[] = [
    ...
    },
    {
        ...
        steps: [
            '「경기 확인 요청」은 «승인 요청»과 «상대 승인 대기» 두 탭입니다. 승인 요청은 지금 내가 답할 것들이고, 안에서 «초대»(참여 수락) · «경기 결과 확정»(결과 확인·입력) · «이의 신청»으로 다시 나뉘어요. 내 승인이 끝나면 그 경기는 상대 승인 대기로 옮겨가고, 모두가 승인하면 「개인 경기 결과」로 갑니다. 탭의 숫자는 그 자리에 있는 건수이고, 색이 들어간 숫자와 «승인 필요» 표시가 «지금 내 차례»입니다 — 사이드바 숫자는 승인 요청 탭의 내 차례를 더한 것이에요.',

...
const SECTIONS: GuideSection[] = [
    ...
    },
    {
        icon: Inbox,
        title: '2. 경기 결과 확인받기',
        lead: '상대가 회원이면 결과는 회원 참가자 전원이 동의해야 확정됩니다. 그 전까지는 확인 요청에서 기다립니다.',
        steps: [
            '「경기 확인 요청」은 «승인 요청»과 «상대 승인 대기» 두 탭입니다. 승인 요청은 지금 내가 답할 것들이고, 안에서 «초대»(참여 수락) · «경기 결과 확정»(제안된 결과 확인) · «이의 신청»으로 다시 나뉘어요. 내 승인이 끝나면 그 경기는 상대 승인 대기로 옮겨가고, 모두가 승인하면 「개인 경기 결과」로 갑니다 — 초대가 전원 수락된 경기·로테이션 일정은 거기 «결과 입력 대기»에서 스코어를 넣어요. 탭의 숫자는 그 자리에 있는 건수이고, 색이 들어간 숫자와 «승인 필요» 표시가 «지금 내 차례»입니다 — 사이드바 숫자는 승인 요청 탭의 내 차례를 더한 것이에요.',
            '한 명이 게임 스코어를 제안하면 나머지 회원 참가자가 각자 확인하거나 이의를 제기합니다. 복식은 4명이 모두 확인해야 확정돼요.',
            '이의는 게임에 참여한 사람 누구나 낼 수 있어요 — 이미 확인을 눌렀어도 확정 전이면 [이의 제기]가 남아 있습니다. 이의가 나오면 제안자의 «이의 신청» 탭에 «다시 입력할 차례»로 뜨고, 다시 입력되면 나머지 참가자의 «이의 신청» 탭에 «재입력된 결과 확인»으로 옵니다. 기다리는 동안은 «상대 승인 대기»에서 누구의 이의였는지와 직전 사유를 카드에서 볼 수 있어요.',

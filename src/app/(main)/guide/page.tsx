...
const SECTIONS: GuideSection[] = [
    ...
    },
    {
        ...
        steps: [
            '「경기 확인 요청」은 «승인 요청» · «경기 확정 대기» · «상대 승인 대기» · «이의 처리» 네 탭입니다. 앞의 둘이 갈린 이유는 «승인»은 남의 제안에 답하는 일이고 «확정»은 내가 스코어를 채워 넣는 일이라 무게가 다르기 때문이에요. 탭의 숫자는 그 탭에 있는 건수이고, 색이 들어간 숫자가 «지금 내 차례»입니다 — 사이드바 숫자는 그 내 차례들을 더한 것이에요.',
            '한 명이 게임 스코어를 제안하면 나머지 회원 참가자가 각자 확인하거나 이의를 제기합니다. 복식은 4명이 모두 확인해야 확정돼요.',
            '이의가 나온 경기는 확정될 때까지 «이의 처리» 탭에 머뭅니다. 제안자가 그 탭에서 다시 입력하면, 이의를 낸 사람과 나머지 참가자가 «재입력된 결과 확인»에서 바로 승인할 수 있어요. 카드에 누구의 이의였는지와 직전 사유가 함께 보입니다.',

...
import { getProfileNavItem } from '@/lib/nav-items'
...
export default async function MainLayout({
    ...
    const profileNavItem = user ? getProfileNavItem(user.id) : null

    return (
        <div className="flex h-screen bg-background">
            <Sidebar matchGameHref={matchGameHref} profileNavItem={profileNavItem} />

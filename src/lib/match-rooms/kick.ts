...
/**
 * 방장의 강퇴 자격 (순수 — DB 가드 kick_room_member(0068·0070)의 거울).
 *
 * 강퇴는 '차단'이다: 비밀번호를 알아도 재입장할 수 없고, 룸 상세도 보이지 않으며(0070),
 * 방장의 재초대로만 풀린다. 내보낸 사람은 명단에서도 사라지므로 되돌리는 길은
 * [회원 초대] 검색이다 — 거기서 방장에게만 강퇴자가 후보로 남는다(inviteExcludedUserIds).
 *
...
/** [내보내기] — 방장이, 아직 방에 있고 **경기에 배정되지 않은** 다른 회원에게만 */

...
const FLOW: GuideSection = {
    ...
    steps: [
        `함께 칠 사람을 모읍니다. ${em('매칭 만들기')}로 매칭을 열어 ${HOST_LABEL}가 되거나, 매칭 리스트에서 비밀번호로 들어가 참가자가 됩니다. 초대를 받았다면 ${em('참가 수락')}만 누르면 됩니다.`,
        ...
        '모든 게임이 확정되면 매칭이 종료되고, 그 경기들은 개인 경기 결과와 내 통계에 반영됩니다.',
    ],
}
